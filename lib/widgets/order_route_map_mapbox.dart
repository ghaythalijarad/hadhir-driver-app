...
class OrderRouteMapMapbox extends StatefulWidget {
  final OrderModel order;
  final double height;
  final bool isInDialog;
  final Point? driverLocation;

  const OrderRouteMapMapbox({
    super.key,
    required this.order,
    this.height = 200,
  ...
  @override
  State<OrderRouteMapMapbox> createState() => _OrderRouteMapMapboxState();
}

class _OrderRouteMapMapboxState extends State<OrderRouteMapMapbox> {
